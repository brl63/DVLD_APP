...
2. **Database Setup:**
   ...
   ** or you can use the backup file u will find it in the databasefolder - In the **Object Explorer**, right-click on the **Databases** folder and select **Restore       Database...**.
   - Under the **Source** section, select **Device**, then click the Browse button (`...`).
...
<img width="1920" height="1080" alt="Screenshot (486)" src="https://github.com/user-attachments/assets/a9e17efa-5f95-4502-8599-bbadaed7729a" />
<img width="1920" height="1080" alt="Screenshot (485)" src="https://github.com/user-attachments/assets/b5a1f633-0bc4-4f19-b9fe-e05b510dee6c" />
<img width="1920" height="1080" alt="Screenshot (484)" src="https://github.com/user-attachments/assets/4daf31d3-acba-427f-924f-b194d1a777d4" />
<img width="1920" height="1080" alt="Screenshot (483)" src="https://github.com/user-attachments/assets/de346176-ce9a-4400-8724-8b5296829bbb" />
